...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSwiper.initSimpleSlider)();
...
},{"./modules/form-validate/form":3,"./modules/swiper/init-swiper":9,"./modules/tabs/init-tabs":10,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
exports.simpleSlider = exports.initSimpleSlider = exports.initHeroSlider = exports.heroSlider = void 0;
var _window = window,
...
var initHeroSlider = function initHeroSlider() {
  exports.heroSlider = heroSlider = new Swiper('.slider--hero', {
    // Optional parameters
...
var initSimpleSlider = function initSimpleSlider() {
  exports.simpleSlider = simpleSlider = new Swiper('.js-simple-swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    // If we need pagination
...
exports.initSimpleSlider = initSimpleSlider;
